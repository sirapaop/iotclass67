...
1. เริ่มจากการดึง plugin flowcharting ที่ install ข้างต้นมาใช้งานโดยกด add ที่มุมขวาบนเลือก virsualization แล้วค้นหาคำว่า flowcharting 
...
4. รับค่า sensor มาแสดงบน drawio ที่สร้างผ่าน Prometheus ทำให้เราสามารถ query ค่าออกมาใช้งานได้ 
    ...
    - เลือก selected label เป็น sensor_name เพื่อให้หา sensor ได้ง่ายเวลา map
    - จากนั้นกด run request

5. map ค่าระหว่างกล่องโปร่งใสที่สร้างกับ sensor
    - ไปที่ Rules
    - เลือกค่าที่ต้องการแสดง apply to metrics โดยเลือก sensor ที่ต้องการแสดงค่าในตำแหน่งนี้
